            ...
            <ContactPageWrapper>
                <ContactInfoContainer>
                    ...
                    <div style={{marginTop: '30px', borderTop: '1px dashed #eee', paddingTop: '20px', width: '100%', maxWidth: '350px'}}>
                        <p style={{ color: '#555', marginBottom: '15px', fontWeight: '600' }}>Hoặc theo dõi chúng tôi:</p>
                    ...
                    <p style={{ marginTop: '20px', color: '#555' }}>{t('footer.hotline')}</p>
                    <p style={{ color: '#555' }}>{t('footer.address')}</p>
                </ContactInfoContainer>
